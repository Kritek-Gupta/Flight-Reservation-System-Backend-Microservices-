package com.urs.passenger.utility;
...
public class LoggingAspect {
	...
	@AfterThrowing(pointcut = "execution(* com.urs.flight.api.*.*(..))", throwing = "exception")
	...
	@AfterThrowing(pointcut = "execution(* com.urs.flight.service.*.*(..))", throwing = "exception")
